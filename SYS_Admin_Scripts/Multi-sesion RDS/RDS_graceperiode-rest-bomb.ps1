<#
.SYNOPSIS
    ** For reseting graceperiode time for RDS. **

.DESCRIPTION
    This script is called - Time_Bomb for reseting timer for graceperiod of RDS. Put this scritp in taskScheduler for fully automation after 120days.

.NOTES
    Use PWSH automation for easier life.
    RDS Graceperiod is 120Days.
