...
# This is local script and will parse data from cmd window of a caller script
param (
    [string]$userName,
    [string]$userTitle,
    [string]$userMail,
...
# Create the user hash table with input data
$user = @{
    name      = "Jernej Sivec"
    title     = "Carpentry Workshop Manager"
    mail      = "jernej.sivec@spintecgaming.com"
    telephone = ""
    mobile    = ""
    company   = "ARKA"
}
...
$logo = 'C:\Spintec\Signature\arka-logo.png'
